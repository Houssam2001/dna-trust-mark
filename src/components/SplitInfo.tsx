            ...
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-1 md:order-2">
                        <h4 className="text-primary font-bold tracking-widest text-xs md:text-sm mb-3 md:mb-4 ">{t("home.intro.subtitle")}</h4>
                        <h2 className="text-3xl md:text-5xl font-bold text-[#0D2B23]  mb-4 md:mb-6 leading-tight">
