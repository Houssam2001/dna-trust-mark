        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#offers" className="text-secondary-foreground/70 hover:text-primary transition-colors">
                  Our Offers
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#values" className="text-secondary-foreground/70 hover:text-primary transition-colors">
                  Our Values
                </a>
              </li>
              <li>
